...
export { NavBar, SearchResult, Home, PlayBar, SavedMusicPage, SidebarMenu, Setting, default_thumbnail_50x50, default_thumbnail_500x500, defaultTrackPath, bg, bg2, bg3, bg4, bg5, bg6, bg7, bg8, bg9, bg10, bg11, bg12, bg13}